...
import { BASKET_ROUTE, SHOP_ROUTE } from '../../../../utilities/consts';
import { VK_LINK, CONTACTS_ROUTE } from '../../../../utilities/consts';
			...
			<Toolbar sx={{ justifyContent: 'space-around' }}>
				...
				>
					<MenuItem onClick={handleClose}>
						<Link className={styles.dropdown} href={CONTACTS_ROUTE}>
							Контакты
						</Link>
					</MenuItem>
					<MenuItem onClick={handleClose}>
						<Link className={styles.dropdown} href={SHOP_ROUTE}>
							Каталог
						</Link>
					</MenuItem>
					<MenuItem onClick={handleClose}>
						<Link className={styles.dropdown} href={BASKET_ROUTE}>
							Корзина
						</Link>
					</MenuItem>
				</Menu>
